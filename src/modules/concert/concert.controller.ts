import { Body, Controller, Get, Param, ParseIntPipe, Post, Query, UseGuards, Res } from '@nestjs/common';
...
export class ConcertController {
  ...
  async getOrderProof(
    ...
    const order = await this.concertService.getOrderForProof(organizationId, orderId);
